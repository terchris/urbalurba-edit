...
var dummyData2 = {
  categories: [
    {
      id: "5f325893203f6aa19031ff4d",
      idName: "sustainability",
      displayName: "Bærekraft",
      summary: "Bærekraftsinnvirkning",
      categoryType: "input",
      image: {
        icon:
          "http://bucket.urbalurba.com/cat/sustainability/sustainability-logo-large.jpg"
      },
      categoryitems: [
        {
          id: "5f325893203f6aa19031ff58",
          idName: "economic",
          displayName: "Økonomisk",
          summary: "Innvirkning på økonomisk bærekraft",
          description: "Beskriv hvordan",
          image: {
            icon:
              "http://bucket.urbalurba.com/cat/sustainability/economic-medium.png"
          }
        },
        {
          id: "5f325893203f6aa19031ff63",
          idName: "social",
          displayName: "Sosialt",
          summary: "Innvirkning på sosial bærekraft",
          description: "Beskriv hvordan",
          image: {
            icon:
              "http://bucket.urbalurba.com/cat/sustainability/social-medium.png"
          }
        },
        {
          id: "5f325893203f6aa19031ff6e",
          idName: "environment",
          displayName: "Miljø",
          summary: "Innvirkning på miljømessig bærekraft",
          description: "Beskriv hvordan",
          image: {
            icon:
              "http://bucket.urbalurba.com/cat/sustainability/environment-medium.png"
          }
        }
      ]
    }
  ...
  entityCategoryAnswers: [
    {
      id: "5f338d72203f6aa1903223ee",
      text:
        "Sparer kommunen for penger. Driftskostnadene blir inntil 80% mindre enn for de gamle dieseldrevne fergene.",
      categoryitem: {
        id: "5f325893203f6aa19031ff58",
        idName: "economic"
      },
      entity_category: {
        id: "5f338cea203f6aa1903223ed"
      }
    },
    {
      id: "5f338e49203f6aa1903223ef",
      text: "Innbyggerne har et miljøvennlig alternativ til transport",
      categoryitem: {
        id: "5f325893203f6aa19031ff63",
        idName: "social"
      },
    ...
    {
      id: "5f338e9c203f6aa1903223f0",
      text: "Mindre forurensning og mindre støy",
      categoryitem: {
        id: "5f325893203f6aa19031ff6e",
        idName: "environment"
      },
...
function readDefaultValues(
  ...
  for (let i = 0; i < categoryitems.length; i++) {
    ...
    console.log("text is:", inputAnswers[`${categoryitems[i].idName}-text`]);

    if (inputAnswers[categoryitems[i].idName] && alreadyChecked) {
      // if the checkbox is checked and it was checked before editing

      //now lets see if the text has changed
      if (
        alreadyChecked.text === inputAnswers[`${categoryitems[i].idName}-text`]
      ) {
        // if the txt has not changed
        console.log(
          "idName:",
          categoryitems[i].idName,
          " ACTION checkbox and text unchanged"
        );
        ...
        console.log(
          "idName:",
          categoryitems[i].idName,
          " ACTION checkbox not changed. But text has changed"
        );
        newEntityCategoryAnswerRecord.action = "UPDATE";
        newEntityCategoryAnswerRecord.text =
          inputAnswers[`${categoryitems[i].idName}-text`]; // take the text from the input
      }
...
export default function CategoryItemListInput() {
        ...
        <section>
          ...
          <List dense className={classes.root}>
            {category.categoryitems.map((currentCategory) => {
              return (
                <div key={currentCategory.idName}>
                  ...
                  {watchAllFields[`${currentCategory.idName}`] && (
                    <div>
                      <Controller
                        as={TextField}
...
/*
                <Controller as={TextField} name={`${currentCategory.idName}-text`} control={control} />
